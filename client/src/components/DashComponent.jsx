      ...
      <div className="flex-wrap flex gap-4 justify-center">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiVideoCamera className="bg-lime-600 text-white rounded-full text-5xl p-3 shadow-lg" />
          </div>
          <div className="flex gap-2 text-sm">
            <span className="text-green-500 flex items-center">
              <HiArrowNarrowUp />
      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        ...
        <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to="/dashboard?tab=videos">See all</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
              ...
              <Table.HeadCell>Video category</Table.HeadCell>
            </Table.Head>
            {videos &&
              videos.map((video) => (
                <Table.Body key={video._id} className="divide-y">
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    <Table.Cell>
                      <img
                        src={video.image}
                        className="w-20 h-15 rounded-md bg-gray-500"
                      />
                    </Table.Cell>
                    <Table.Cell className="w-96" >{video.title}</Table.Cell>
                    <Table.Cell className="w-5">{video.category}</Table.Cell>
                  </Table.Row>
                </Table.Body>
              ))}
          </Table>
